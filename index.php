        ...
        <div class="item">
            ...
            <div class="grid-text-div">
                ...
                <div class="grid-date-div">
                    ...
                    <a onclick="location.href='project.php?project=1'" class="grid-div-button">></a>
                </div>
            </div>
        </div>
        <div class="item">
            <div>
                ...
                <div class="grid-date-div">
                    ...
                    <a onclick="location.href='project.php?project=2'" class="grid-div-button">></a>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="grid-text-div">
                ...
                <div class="grid-date-div">
                    ...
                    <a onclick="location.href='project.php?project=3'" class="grid-div-button">></a>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="grid-text-div">
                ...
                <div class="grid-date-div">
                    ...
                    <a onclick="location.href='project.php?project=4'" class="grid-div-button">></a>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="grid-text-div">
                ...
                <div class="grid-date-div">
                    ...
                    <a onclick="location.href='project.php?project=5'" class="grid-div-button">></a>
                </div>
            </div>
        </div>
        <div class="item">
            ...
            <div class="grid-text-div">
                ...
                <div class="grid-date-div">
                    ...
                    <a onclick="location.href='project.php?project=6'" class="grid-div-button">></a>
                </div>
            </div>
        </div>
    </div>
